...
function TaskListMenu() {
  ...
  return (
    <DragDropContext onDragEnd={handleTaskListDragEnd}>
      <section className='shadow-md h-[88%] w-70 tablet:w-100 rounded-12 bg-background-secondary dark:bg-background-secondary-dark px-10 tablet:px-15 items-center py-25 text-center'>
        <div className='flex items-center justify-center'>
          <p className='text-text-default dark:text-text-default-dark text-md text-medium hidden tablet:block'>
            목록 메뉴
          </p>
