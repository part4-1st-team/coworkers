...
function Terms() {
  ...
  const handleModalOpen = () => {
    setModalOpen(
      <div>
        <span className='flex'>
          <h1 className='block font-bold text-brand-primary'>coworkers</h1>
          <h1 className='block ml-8'>개인정보 수집 / 이용약관(필수)</h1>
        </span>
        <div className='h-150 overflow-scroll'>
          <Modal.Description
            description='1. 개인정보 수집 항목 회사는 서비스 제공을 위해 다음과 같은
            ...
            <br />
            <br /> 5. 개인정보 처리 위탁 회사는 서비스 이행을 위해 외부 업체에
            개인정보 처리를 위탁할 수 있으며, 위탁하는 업무의 내용은 다음과
            같습니다: 위탁받는 자: [coworkers] 위탁 업무 내용: 데이터 저장 및
            처리, 결제 대행 등<br />
            <br />
            6. 개인정보의 파기 절차 및 방법 회사는 개인정보 보유 기간이
            경과하거나 처리 목적이 달성된 경우, 해당 정보를 지체 없이
            파기합니다. 파기 방법은 다음과 같습니다: 전자적 파일: 복구 불가능한
            방법으로 삭제 서면 자료: 분쇄기로 분쇄하거나 소각
            <br />
            <br />
