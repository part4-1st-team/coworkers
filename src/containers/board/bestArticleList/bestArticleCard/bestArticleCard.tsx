...
function BestArticleCard({ article, className }: BestArticleCardProps) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={clsx(
        'w-full tablet:h-220 pt-9 pb-16 px-24 bg-background-secondary dark:bg-background-secondary-dark rounded-12 border border-background-tertiary dark:border-background-tertiary-dark',
        className,
      )}
    >
